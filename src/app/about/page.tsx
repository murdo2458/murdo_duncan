...
export const metadata: Metadata = {
  title: 'About',
  description:
    'I’m Murdo Duncan. I live in Edinburgh, where I work at Stampede.',
}
...
Thanks for visiting the site. I worked for way longer than I should have on the light mode/dark mode button so please try it.
        ...
        <div className="lg:pl-20">
          <ul role="list">
            ...
            <SocialLink href="https://www.instagram.com/__murdo_/" icon={InstagramIcon} className="mt-4">
              Follow on Instagram
            </SocialLink>
            <SocialLink href="https://github.com/murdo2458" icon={GitHubIcon} className="mt-4">
              Follow on GitHub
            </SocialLink>
            <SocialLink href="https://uk.linkedin.com/in/murdo-duncan-3ba958143" icon={LinkedInIcon} className="mt-4">
              Follow on LinkedIn
            </SocialLink>
            <SocialLink
